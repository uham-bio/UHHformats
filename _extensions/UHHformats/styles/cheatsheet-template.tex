...
% Font is set via the 'mainfont' YAML option (default: "Helvetica Neue").
% When using the R package version, fonts are copied as TTF files instead.
...
\lfoot{}
$endif$
\rfoot{\footnotesize $author$ \enspace \textbullet  \enspace $date$ \enspace \textbullet  \enspace  $if(license)$$license$$endif$}
