...
- `logo`: The footer logo is controlled by the file `images/logo.png`. To use a different logo, replace that file with your own (keeping the name `logo.png`). To show no logo at all, simply delete or remove `images/logo.png`.
